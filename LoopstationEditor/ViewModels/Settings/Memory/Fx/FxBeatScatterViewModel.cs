...
namespace LoopstationEditor.ViewModels.Settings.Memory.Fx
{
    public class FxBeatScatterViewModel : FxBeatViewModel
    {
        ...
        {
            BeatScatterType = new PropertyEnumRadioViewModel<FxBeatScatterType>(nameof(model.BeatScatterType), PropertySet);
            BeatScatterLength = new PropertyEnumComboViewModel<FxBeatScatterLength>(nameof(model.BeatScatterLength), PropertySet, new EnumNoteConverter<FxBeatScatterLength>());
        }
    }
}
